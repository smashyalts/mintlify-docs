...
<AccordionGroup>
  ...
  <Accordion title="It is pinned to one server build">
    The plugin compiles against the Mojang-mapped server for the handful of things Bukkit does not expose: rewriting an entity id, neutralising the login teleport, reading outgoing block updates, the advancement file. A different Paper build family will not run it.
  </Accordion>
